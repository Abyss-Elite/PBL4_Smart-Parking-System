      ...
      <table className="min-w-full text-sm text-left">
        <thead className="bg-gray-100 text-gray-700">
          <tr>
            ...
            {type === "reserved" && (
              <>
                <th className="px-4 py-3">Mã đặt trước</th>
              </>
            )}
          </tr>
        </thead>
        ...
        <tbody>
          {data.map((item, index) => (
            ...
            >
              ...
              <td className="px-4 py-3">{item.totalTime}</td>
              ...
              <td className="px-4 py-3">{item.paymentTime}</td>
              {type === "reserved" && (
                <>
                  <td className="px-4 py-3">{item.reservedCode}</td>
                </>
              )}
            </tr>
          ))}
